...
app.post('/api/platform/serviceCategory', createServiceCategoryController.createCategory);
app.get('/api/platform/serviceCategory/:id', readServiceCategoryController.getCategoryById);
app.put('/api/platform/serviceCategory/:id', updateServiceCategoryController.updateCategory);
app.delete('/api/platform/serviceCategory/:id', deleteServiceCategoryController.deleteCategory);
app.get('/api/platform/serviceCategories/search', searchServiceCategoryController.searchCategories);
// Platform Management - Metrics API
app.get('/api/platform/report/daily/:date', readDailyReportController.getDailyStats);
app.get('/api/platform/report/weekly/:monday', readWeeklyReportController.getWeeklyStats);
app.get('/api/platform/report/monthly/:year/:month', readMonthlyReportController.getMonthlyStats);
