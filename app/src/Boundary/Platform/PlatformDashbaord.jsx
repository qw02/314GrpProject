...
/**
 * Dashboard component for users with the 'PlatformManager' role.
  ...
  return (
    <div>
      ...
      <nav>
        <ul>
          <li>
            <Link to="/platform/serviceCategory">Manage Service Categories</Link>
          </li>
          <li>
            <Link to="/platform/reports">View Reports</Link>
          </li>
        </ul>
      </nav>
